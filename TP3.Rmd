...
El valor obtenido se debería aproximar al nivel del IC y efectivamente lo hace. Esto se debe a que al trabajar con un $IC = ( a(X_1, … , X_n), b(X_1, … , X_n) ) = 0,95$, al tomar muchos ejemplos/muestras de $IC_{obs}$, el 0,95 porciento de las veces, $\mu_0=60$ ($\mu_0$ porque es conocida) va a estar dentro de los intervalos que tome la variable $ic_{correctos}$
